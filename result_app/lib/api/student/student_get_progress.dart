...
Future<List> studentGetProgress({@required BuildContext context}) async {
  try {
    ...
    var request = http.Request(
        'GET', Uri.parse('https://result.onrender.com/result/${data.getId}'));
    ...
    if (status == 200) {
      ...
      if (res.containsKey("result") &&
          res.containsKey("SGPA") &&
          res.containsKey("CGPA")) {
        return [
          true,
          res["result"],
          res["SGPA"] as List,
